<header class="app-header">
    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="col-4 ms-n4">
                            <div class="position-relative p-7 border-start h-100">
                                ...
                                <ul class="">
                                    <li class="mb-3">
                                        <a
                                            class="fw-semibold text-dark bg-hover-primary text-decoration-none text-decoration-none text-decoration-none text-decoration-none">
        ...
        <div class="d-block d-lg-none">
            <img src="{{ asset('back/dist/images/logos/dark-logo.svg') }}" class="dark-logo" width="180"
                alt="" />
        </div>
